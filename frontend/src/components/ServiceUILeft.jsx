...
export default function ServiceUILeft({
  title,
  description,
  subHeading,
  first,
  ...
  return (
    <div className="flex items-center justify-around  p-10 gap-5">
      ...
      <div className="w-1/2 flex flex-col gap-2 p-10 ">
        ...
        <button className=" w-fit p-4 rounded-lg bg-blue-600 text-white">
          View More
        </button>
      </div>
    </div>
